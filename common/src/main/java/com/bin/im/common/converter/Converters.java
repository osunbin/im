        ...
        for (Converter converter : converters) {
            ...
            if (valueClass != null) {
                ...
                if (prevConverter != null) {
                    throw new RuntimeException("Duplicate converter for class [class=" + valueClass
    ...
    private static Converter[] createConvertersArray(List<Converter> converters) {
        ...
        for (Converter converter : converters) {
            ...
            if (oldConverter != null) {
                throw new RuntimeException("Two converters have the same ID [id=" + converter.getId()
        ...
        if (maxId > MAX_CONVERTER_COUNT) {
            throw new RuntimeException("Converter ID cannot be greater than " + MAX_CONVERTER_COUNT + ": "
        ...
        for (int i = 0; i <= maxId; i++) {
            ...
            if (converter == null) {
                throw new RuntimeException("Converter with ID " + i + " is not defined");
            }
