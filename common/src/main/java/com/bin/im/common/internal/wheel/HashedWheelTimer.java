...
public class HashedWheelTimer implements Timer {
    ...
    public HashedWheelTimer(
        ...
        MPSCQueue<HashedWheelTimeout> timeoutMpscQueue = new MPSCQueue<>(null);
        timeoutMpscQueue.setConsumerThread(workerThread);
        timeouts = timeoutMpscQueue;

        MPSCQueue<HashedWheelTimeout> ctMpscQueue = new MPSCQueue<>(null);
        ctMpscQueue.setConsumerThread(workerThread);
        cancelledTimeouts = ctMpscQueue;
    ...
    private static HashedWheelBucket[] createWheel(int ticksPerWheel) {
        ...
        if (1>ticksPerWheel || ticksPerWheel > 1073741824) {
